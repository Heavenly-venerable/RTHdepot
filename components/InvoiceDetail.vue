...
<template>
  <div class="p-4 sm:p-6 max-w-2xl mx-auto bg-white dark:bg-zinc-900 shadow-md dark:shadow-none rounded-lg">
    <Card class="dark:shadow-none dark:border dark:border-zinc-700">
      ...
      <template #content>
        <div v-if="!invoice" class="text-center text-red-500 dark:text-red-400">
